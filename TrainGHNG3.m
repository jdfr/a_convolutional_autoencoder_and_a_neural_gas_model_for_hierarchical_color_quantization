function [Model] = TrainGHNG3(Samples,Epochs,MaxNeurons,Tau,Lambda,EpsilonB,EpsilonN,Alpha,AMax,D,Level)
...
Model = TrainGNG3(Samples,MaxNeurons,Lambda,EpsilonB,EpsilonN,Alpha,AMax,D,NumSteps,Tau);
...
for NdxNeuro=NdxNeurons
    ...
    Model.Child{NdxNeuro} = TrainGHNG3(ChildSamples,Epochs,...
