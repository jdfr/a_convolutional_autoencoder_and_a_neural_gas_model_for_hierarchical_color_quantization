...
function PruebasCuantificacionDivergenciasBregmanAutoencoder(imgExt, RutaImagenes, foldingNumber, hiddenLayer, useAutoEncoder, evaluateAutoEncoder, endAfterEvaluatingAutoEncoder)
if false
