% Pruebas Clustering GNG de la BBDD MNIST para dígitos pares, impares o
% todos SIN PCA
clear all
...
NomFichSalida = ['Modelos_GNG_' NomFich];
...
NomFichSalida = ['Plot_GNG_' NomFich];
...
save(['./Resultados_GNG_' NomFich '.mat'],'MSE','PSNR','DB','CS','Time');
