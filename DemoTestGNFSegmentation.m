...
%         MyThreshold = 0;
        ...
        ForegroundPixels3 = (ForegroundPixels - BackgroundPixels) == 1;
        imMask3 = reshape(ForegroundPixels3,size(MyFrame,1),size(MyFrame,2));       
        ...
        imMaskPost2 = bwmorph(imMask2,'majority');
        imMaskPost2 = removeSpuriousObjects(imMaskPost2, MinArea);
        imMaskPost3 = bwmorph(imMask3,'majority');
