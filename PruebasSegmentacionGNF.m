...
NomFichResultados = 'ResultadosSegmentacionGNF';
PathDatos = 'Datos/Mediana 100 últimos sin NaN Mu=2/';
...
% for NdxColorSpace=4:4,
    ...
    for NdxVideo=1:NumVideos,
        ...
        if (isempty(Results{NdxColorSpace,NdxVideo})),
            ...
            PerformanceMeasures = TestGNFSegmentation(Modelo,Winners,Errors,...
                MyColorSpace,MyVideo,NumFrames(NdxVideo),NumGTFrames(NdxVideo),DeltaFrames(NdxVideo),PathMyVideo,PathMyGT,Mu); 
